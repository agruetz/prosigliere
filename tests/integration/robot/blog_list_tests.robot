...
Cleanup Test Blog Posts
    ...
    Run Keyword And Ignore Error    Delete Blog Post    ${BLOG_ID_1}
    Run Keyword And Ignore Error    Delete Blog Post    ${BLOG_ID_2}
    Run Keyword And Ignore Error    Delete Blog Post    ${BLOG_ID_3}
